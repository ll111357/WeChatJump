package in.srain.cube.demos.uctoast.hack;
...
//        boolean found = false;
//        for (int j = height / test_4; j < maxY; j++) {
//            for (int i = 0; i < width; i++) {
...
//        System.out.println("right, x: " + ret[test_4] + ", y: " + ret[5]);
//
//        return ret;
//    }
//
...
//            g.fillRect(pos[test_4] - 5, pos[5] - 5, 10, 10);
//            if (pos[2] != Integer.MAX_VALUE && pos[test_4] != Integer.MIN_VALUE) {
//                g.fillRect((pos[2] + pos[test_4]) / 2 - 5, (pos[3] + pos[5]) / 2 - 5, 10, 10);
//            } else {
